        ...
        <Grid container item xs={11} spacing={4}>
          ...
          <Grid item xs={12} md={3} style={{ margin: "0 auto" }}>
            <Box display="flex" justifyContent="space-around" mb={3}>
              <Link
                href="https://www.facebook.com/Sentircreativo/"
                target="_blank"
              >
                <Avatar
                  alt="Icono"
              ...
              <Link
                href="https://www.instagram.com/sentircreativo/"
                target="_blank"
              >
                <Avatar
                  alt="Icono"
              ...
              <Link href="https://twitter.com/sentir_creativo" target="_blank">
                <Avatar
                  alt="Icono"
                  src={
                    "https://play-lh.googleusercontent.com/J8k5q78xv4R8Smi4vOE6iUphLvOz0efC-0lzoyGfd0KRUlAv4ekuCtlss6KBN-tMvEw"
                  }
                  style={{ width: "4rem", height: "4rem", borderRadius: "50%" }}
                />
              </Link>
            ...
            <Card style={{ borderRadius: 16 }}>
              <CardContent component={Grid} container spacing={2}>
                <Grid item xs={3}>
                  <CardMedia
                    image={
                      "https://pbs.twimg.com/profile_images/666413114489831424/aJZNErvd_400x400.png"
                    }
                    component="img"
                    width="65"
                    height="65"
                ...
                <Grid item xs style={{ textAlign: "right" }}>
                  <Button
                    ...
                    href="https://www.flickr.com/photos/sentircreativo/albums"
                    target="_blank"
                  >
                    VER BITÁCORAS
                  </Button>
...
function Copyright() {
  return (
    <Box bgcolor="rgba(0 0 0 / 20%)" width="100%" color="#fff" px={4} py={1}>
  ...
  return (
    <Card style={{ borderRadius: 24 }}>
      <CardHeader
        ...
        avatar={
          <Avatar
            src="https://sentircreativo.s3.us-east-2.amazonaws.com/images/staff/Perfil-Colibri-marzo22.png"
      ...
      <CardActions>
        <Box display="flex" justifyContent="flex-end" width="100%" mt={1} p={1}>
          <Tooltip title="Whatsapp">
            <IconButton
              size="medium"
              variant="contained"
              href={
                "https://wa.me/+56968498645?text=" +
                window.encodeURIComponent("Hola buen dia")
              }
              target="_blank"
